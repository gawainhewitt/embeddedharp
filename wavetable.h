...
void playSound(int octave, int note) {
    ...
    {
        case 0:
            wavetable1.playFrequency(freqnotes[note][octave]);
            break;
        case 1:
            wavetable2.playFrequency(freqnotes[note][octave]);
            break;
        case 2:
            wavetable3.playFrequency(freqnotes[note][octave]);
            break;
        case 3:
            wavetable4.playFrequency(freqnotes[note][octave]);
            break;
        case 4:
            wavetable5.playFrequency(freqnotes[note][octave]);
            break;
        case 5:
            wavetable6.playFrequency(freqnotes[note][octave]);
            break;
        case 6:
            wavetable7.playFrequency(freqnotes[note][octave]);
            break;
        case 7:
            wavetable8.playFrequency(freqnotes[note][octave]);
            break;
        case 8:
            wavetable9.playFrequency(freqnotes[note][octave]);
            break;
        case 9:
            wavetable10.playFrequency(freqnotes[note][octave]);
            break;
        case 10:
            wavetable11.playFrequency(freqnotes[note][octave]);
            break;
    }
